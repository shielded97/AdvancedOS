...
uint8_t BC; //NB = Block Count - 1
uint8_t XH; 
uint8_t RC;  
uint8_t blocks[BLOCKS_PER_EXTENT]; // array of disk sectors used
} DirStructType;

// for our proj, our file control block is a dir entry
// file control blocks are located in Block 0 in the image1.img file
...
// keep track of free blocks with a 256 element array 
//    Use global boolean array for this
